...
df <- readRDS("Sparsity_Effects_htrlnorm.rds") %>%
...
png("intermediate/effects_htrlnorm.png",width=3600, height=1500, res=300)
...
png("intermediate/examples_htrlnorm.png", width=3600, height=4800, res=300)
pall
dev.off()